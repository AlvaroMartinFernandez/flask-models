// Paleta de colores para el video educativo de SQLAlchemy
export const colors = {
  // Fondo y texto base
  ...
  sqlalchemy: {
    model: '#569cd6',            // Azul para modelos
    column: '#9cdcfe',           // Azul claro para columnas
    relationship: '#4ec9b0',     // Turquesa para relaciones
    foreignKey: '#dcdcaa',       // Amarillo para FKs
  },

  // Relaciones
  relations: {
    oneToOne: '#61affe',         // Azul
    oneToMany: '#49cc90',        // Verde
    manyToMany: '#fca130',       // Naranja
  },
